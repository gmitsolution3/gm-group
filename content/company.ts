export const siteConfig = {
  ...
  contact: {
    email: 'contact@gmgroup.example',
    phone: '+1 (000) 000-0000',
    address: '[City, Country — Placeholder]',
  },
} as const;
...
export const groupIdentity = {
  lines: ['One Group.', 'Multiple Businesses.', 'A Shared Direction.'],
  supportText:
...
export const careersContent = {
  ...
  workingWithUs: [
    {
      title: 'Ownership',
      description: '[Placeholder] People here own their work end-to-end, with the trust and accountability that comes with it.',
    },
    {
      title: 'Collaboration',
      description: '[Placeholder] Businesses across the group share knowledge, tools, and direction.',
    },
    {
      title: 'Development',
      description: '[Placeholder] We invest in continuous learning and growth across every role.',
    },
    {
      title: 'Impact',
      description: '[Placeholder] Work here reaches across industries — not a single product or market.',
    },
  ],
};
