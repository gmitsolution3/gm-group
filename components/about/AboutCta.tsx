      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-12">
        <div className="max-w-4xl">
          ...
          <h2 className="mt-6 font-display text-[clamp(2.5rem,6.5vw,5rem)] font-extrabold leading-[1.02] tracking-tightest text-balance">
            <RevealWords
              text="Discover the businesses behind the group."
              highlightIndices={[5]}
          ...
          <Reveal delay={0.2}>
            <p className="mt-7 max-w-xl text-lg leading-relaxed text-muted-foreground text-pretty">
              Explore the ventures that put our shared direction into
              practice.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.3} className="mt-10 flex flex-wrap gap-4">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center rounded-full border border-black/15 px-7 py-3.5 text-sm font-semibold text-ink transition-colors hover:border-ink hover:bg-black/5"
            >
              Get in Touch
            </Link>
          </Reveal>
