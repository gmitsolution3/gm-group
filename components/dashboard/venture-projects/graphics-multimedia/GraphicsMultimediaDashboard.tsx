              ...
              <div className="rounded-2xl border bg-gradient-to-br from-blue-50/40 to-card p-6 shadow-sm">
                ...
                <div className="grid gap-3">
                  {[
                    {
                      label: "Regular",
                      val: dashboardData.breakdown.bookings.regular,
                      sub: "Standard bookings",
                      color: "blue",
                    },
                    {
                      label: "Custom",
                      val: dashboardData.breakdown.bookings.custom,
                      sub: "Tailored packages",
                      color: "amber",
                    },
                    {
                      label: "Influencer",
                      val: dashboardData.breakdown.bookings
                        .influencer,
                      sub: "Influencer collaborations",
                      color: "purple",
                    },
                  ].map((item) => (
                    <div
                      key={item.label}
                      className="flex items-center justify-between rounded-xl bg-card border px-4 py-3 hover:shadow-sm transition"
                    >
                      <div>
                        ...
                        <p
                          className={`text-2xl font-extrabold ${item.color === "blue" ? "text-blue-600" : item.color === "amber" ? "text-amber-600" : "text-purple-600"}`}
                        >
                          {item.val}
                        </p>
                      </div>
              ...
              <div className="rounded-2xl border bg-gradient-to-br from-emerald-50/40 to-card p-6 shadow-sm">
                ...
                <div className="grid gap-3">
                  {[
                    {
                      label: "Active",
                      val: dashboardData.breakdown.jobs.active,
                      sub: "Currently open",
                      color: "emerald",
                    },
                    {
                      label: "Inactive",
                      val: dashboardData.breakdown.jobs.inactive,
                      sub: "Closed/Draft",
                      color: "rose",
                    },
                  ].map((item) => (
                    ...
                    >
                      <div>
                        ...
                        <p
                          className={`text-2xl font-extrabold ${item.color === "emerald" ? "text-emerald-600" : "text-rose-600"}`}
                        >
                          {item.val}
                        </p>
                      </div>
              ...
              <div className="rounded-2xl border bg-gradient-to-br from-violet-50/40 to-card p-6 shadow-sm">
                ...
                <div className="grid gap-3">
                  {[
                    {
                      label: "Services",
                      val: dashboardData.breakdown.catalog.services,
                      sub: "Individual offerings",
                      color: "violet",
                    },
                    {
                      label: "Packages",
                      val: dashboardData.breakdown.catalog.packages,
                      sub: "Bundled services",
                      color: "indigo",
                    },
                    {
                      label: "Custom Packages",
                      val: dashboardData.breakdown.catalog
                        .customPackages,
                      sub: "Client-specific",
                      color: "fuchsia",
                    },
                    {
                      ...
                      val: dashboardData.breakdown.catalog
                        .influencers,
                      sub: "Available for collaboration",
                      color: "pink",
                    },
                  ].map((item) => (
                    <div
                    ...
                    >
                      <div>
                        ...
                        <p
                          className={`text-2xl font-extrabold ${item.color === "violet" ? "text-violet-600" : item.color === "indigo" ? "text-indigo-600" : item.color === "fuchsia" ? "text-fuchsia-600" : "text-pink-600"}`}
                        >
                          {item.val}
                        </p>
                      </div>
                ...
                <div className="rounded-xl border border-border bg-card p-6">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Latest influencer collaborations
                      </p>
                    </div>
                  </div>
                  <div className="mt-4 space-y-3">
                    {dashboardData.recentInfluencerBookings
                      .slice(0, 3)
                      .map((booking) => (
                        <div
                          key={booking._id}
                        ...
                        >
                          ...
                          <div className="space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                              with {booking.influencer.name} (
                              {booking.influencer.designation})
                            </p>
                          </div>
                        </div>
                      ))}
                    {dashboardData.recentInfluencerBookings.length ===
                      0 && (
                      <p className="text-center text-muted-foreground py-4">
                        No recent influencer bookings
                      </p>
                    )}
                  </div>
                </div>
